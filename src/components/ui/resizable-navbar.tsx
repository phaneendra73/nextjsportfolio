...
export const NavbarLogo = () => {
  return (
    ...
    >
      <Image
        src="https://avatars.githubusercontent.com/u/118047850?s=400&u=41e136972826a1c9e80f37f6aecbf2cc0ce975b1&v=4"
        alt="logo"
        width={30}
        height={30}
...
type NavbarButtonProps<C extends React.ElementType> = {
  as?: C;
  variant?: Variant;
  className?: string;
  children: React.ReactNode;
...
export const NavbarButton = <C extends React.ElementType = 'a'>({
  as,
  variant = 'primary',
  className,
  children,
...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full boder border-transparent flex justify-center space-x-12 px-8 py-4"
    >
      {children}
    </nav>
  );
